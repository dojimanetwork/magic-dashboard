...
export type ETHNFTContractParams = {
  id: string;
  name: string;
  symbol: string;
  baseUri: string;
...
export function GetETHNFTContract(params: ETHNFTContractParams) {
...
export default function EthereumNftTemplateView({
  ...
  const Contract_Id = "EthCrossChainNFT";
  ...
  useEffect(() => {
    ...
    const nftOptions: ETHNFTContractParams = {
      id: Contract_Id,
      name,
      symbol,
      baseUri
    };
    const finalContract = GetETHNFTContract(nftOptions);
