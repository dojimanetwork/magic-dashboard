...
//   contract ${params.name}XNFTContract is ERC721Burnable, AccessControl {
//       address public omniChainNFTContract;
//       bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
  
//       event OmniChainNFTContractUpdated(address omniChainContract);
  
//       constructor(string memory ${params.name}, string memory ${params.symbol}) ERC721(${params.name}, ${params.symbol}) {
