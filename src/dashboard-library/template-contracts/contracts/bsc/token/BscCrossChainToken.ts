export const BscCrossChainTokenTemplate = `// SPDX-License-Identifier: MIT
...
contract BscCrossChainToken is IStateExecutor, Initializable, ERC20Upgradeable, UUPSUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        require(_omniChainContractAddress != address(0), "BscCrossChainToken: OmniChain contract address cannot be zero");
    ...
    function executeState(uint256 /*depositID*/, bytes calldata stateData) external nonReentrant onlyRole(EXECUTE_STATE_ROLE) {
        ...
        require(userBytes.length == 20, "BscCrossChainToken: Invalid address length");
        ...
        require(userAddress != address(0), "BscCrossChainToken: Invalid address");
