export const BscCrossChainNftTemplate = `// SPDX-License-Identifier: MIT
...
contract BscCrossChainNFT is IStateExecutor, Initializable, ERC721Upgradeable, UUPSUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
